...
import kz.iitu.csse.group34.services.INewsService;
...
public class MainController {
    ...
    public MainController(NewsPostRepository newsPostRepository) {
    ...
    public String index(ModelMap model){
        List<NewsPost> newsPosts = (List<NewsPost>) newsPostRepository.findAll();
   ...
   /* @GetMapping(path = "/profile")
    ...
    public String profilePage(Model model){
        List<NewsPost> allPosts = (List<NewsPost>) newsPostRepository.findAll();
    ...
    public String customersPage(HttpServletRequest request, Model model) {
        ...
        model.addAttribute("posty", newsPostRepository.findAll(PageRequest.of(page, size)));
        return "profile";
    }
    ...
    @GetMapping("/profile/{pageNo}/{pageSize}")
    public List<NewsPost> getPaginatedCountries(@PathVariable int pageNo,
